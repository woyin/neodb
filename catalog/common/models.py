...
class IdType(models.TextChoices):
    ...
    BibliotekDK_Edition = "bibliotekdk_edition", _("Bibliotek.dk")  # type:ignore[reportCallIssue]
    BibliotekDK_eReolen = "bibliotekdk_ereolen", _("eReolen.dk")  # type:ignore[reportCallIssue]
    BibliotekDK_Work = "bibliotekdk_work", _("Bibliotek.dk")  # type:ignore[reportCallIssue]
    Bandcamp = "bandcamp", _("Bandcamp")  # type:ignore[reportCallIssue]
